...
var Webcam = {
	...
	attach : function(e) {
		...
		if (this.userMedia) {
			...
			t.style.width = "" + this.params.dest_width + "px";
			t.style.height = "" + this.params.dest_height + "px";
			var a = this.params.width / this.params.dest_width;
			var s = this.params.height / this.params.dest_height;
			if (a != 1 || s != 1) {
				e.style.overflow = "visible";
				t.style.webkitTransformOrigin = "0px 0px";
				t.style.mozTransformOrigin = "0px 0px";
				t.style.msTransformOrigin = "0px 0px";
				t.style.oTransformOrigin = "0px 0px";
				t.style.transformOrigin = "0px 0px";
				t.style.webkitTransform = "scaleX(" + a + ") scaleY(" + s + ")";
				t.style.mozTransform = "scaleX(" + a + ") scaleY(" + s + ")";
				t.style.msTransform = "scaleX(" + a + ") scaleY(" + s + ")";
				t.style.oTransform = "scaleX(" + a + ") scaleY(" + s + ")";
				t.style.transform = "scaleX(" + a + ") scaleY(" + s + ")"
			}
			e.appendChild(t);
			this.video = t;
			var i = document.createElement("canvas");
			i.width = this.params.dest_width;
			i.height = this.params.dest_height;
			...
			navigator.getUserMedia({
				...
				t.src = window.URL.createObjectURL(e) || e;
				Webcam.stream = e;
				Webcam.loaded = true;
				Webcam.live = true;
	...
	snap : function() {
		if (!this.loaded)
			return this.dispatch("error", "请共享您的摄像头设备!");
		if (!this.live)
			return this.dispatch("error", "请共享您的摄像头设备!");
		if (this.userMedia) {
			...
			var e = this.getMovie()._snap();
			return "data:image/" + this.params.image_format + ";base64," + e
		}
	},
	...
	base64DecToArr : function(e, t) {
		...
		for (var o, h, n = 0, l = 0, d = 0; d < s; d++) {
			h = d & 3;
			n |= this.b64ToUint6(a.charCodeAt(d)) << 18 - 6 * h;
			if (h === 3 || s - d === 1) {
				for ( o = 0; o < 3 && l < i; o++, l++) {
					r[l] = n >>> (16 >>> o & 24) & 255
				}
